...
class Employee
{
  private:       //These are the private data field
   int id;
   int dept_id;
   int yrs_svc;
...
/* Use "this" as a pointer to an object within a method. 

This : Pointer to a class
->

Regular object -- "." opperator will work fine within structures (of a class)
Cannot use "." opperator 

Have to use -> Arrow opperator when pointing to a structure or a class.
